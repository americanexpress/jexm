...
public class IntegerBoxedAdapterTest {

  @Test
  public void testAdaptingInteger100() {
    assertEquals(100, (int) Adapters.adapt(Integer.class, "100"));
  }
  ...
  public void testAdaptingInteger100WithDecimalsZero() {
    assertEquals(100, (int) Adapters.adapt(Integer.class, "100.00"));
  }

  @Test
  public void testAdaptingInteger100WithDecimalsRoundDown() {
    assertEquals(100, (int) Adapters.adapt(Integer.class, "100.75"));
  }

  @Test(expected = NumberFormatException.class)
  public void testAdaptingIntegerInvalidInteger() {
    Adapters.adapt(Integer.class, "hello");
  }

  @Test
  public void testAdaptingIntegerNull() {
    assertNull(Adapters.adapt(Integer.class, null));
  }
}
