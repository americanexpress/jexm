...
public class PersonFullnameHeaderNames implements Serializable {

  public PersonFullnameHeaderNames(String name, String middlename, String lastname) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    PersonFullnameHeaderNames that = (PersonFullnameHeaderNames) o;
