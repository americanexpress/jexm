...
public class PersonFullnameHeaderNamesAndIndexes implements Serializable {

  public PersonFullnameHeaderNamesAndIndexes(String name, String middlename, String lastname) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    PersonFullnameHeaderNamesAndIndexes that = (PersonFullnameHeaderNamesAndIndexes) o;
