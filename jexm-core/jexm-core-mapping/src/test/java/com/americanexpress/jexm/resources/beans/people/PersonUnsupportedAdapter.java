...
public class PersonUnsupportedAdapter implements Serializable {

  @Header(name = "Name")
  private UnsupportedDataType name;

  private static class UnsupportedDataType {
    // there are no rules in our program to convert a raw string into this class
