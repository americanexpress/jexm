...
public class BigDecimalAdapterTest {
  @Test
  public void testAdaptingBigDecimal9876543210987654321() {
    Assert.assertEquals(
        new BigDecimal("9876543210987654321"),
        Adapters.adapt(BigDecimal.class, "9876543210987654321"));
  }
  ...
  public void testAdaptingBigInteger100WithDecimalsZero() {
    assertEquals(
        new BigDecimal("9876543210987654321.00"),
        Adapters.adapt(BigDecimal.class, "9876543210987654321.00"));
  }

  @Test
  public void testAdaptingBigInteger100WithDecimalsRoundDown() {
    assertEquals(
        new BigDecimal("9876543210987654321.75"),
        Adapters.adapt(BigDecimal.class, "9876543210987654321.75"));
  }

  @Test(expected = NumberFormatException.class)
  public void testAdaptingBigIntegerInvalidInteger() {
    Adapters.adapt(BigDecimal.class, "hello");
  }

  @Test
  public void testAdaptingBigIntegerNull() {
    assertNull(Adapters.adapt(BigDecimal.class, null));
  }
}
