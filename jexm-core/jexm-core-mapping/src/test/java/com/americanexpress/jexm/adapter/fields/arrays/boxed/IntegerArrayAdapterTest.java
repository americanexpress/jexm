...
public class IntegerArrayAdapterTest {

  @Test
  public void testAdaptingNullStringShouldReturnEmptyArray() {
    Assert.assertArrayEquals(new Integer[0], Adapters.adapt(Integer[].class, null));
  }

  @Test
  public void testAdaptingEmptyStringShouldReturnEmptyArray() {
    assertArrayEquals(new Integer[0], Adapters.adapt(Integer[].class, ""));
  }
  ...
  public void testAdaptingCommaAloneShouldReturnTwoZeroElements() {
    assertArrayEquals(new Integer[] {null, null}, Adapters.adapt(Integer[].class, ","));
  }
  ...
  public void testAdaptingTwoCommasShouldReturnThreeZeroElements() {
    assertArrayEquals(new Integer[] {null, null, null}, Adapters.adapt(Integer[].class, ",,"));
  }

  @Test
  public void testAdaptingSingleElementShouldReturnSingleElementArray() {
    assertArrayEquals(new Integer[] {1}, Adapters.adapt(Integer[].class, "1"));
  }
  ...
  public void testAdaptingSingleElementDecimalShouldRoundDown() {
    assertArrayEquals(new Integer[] {1}, Adapters.adapt(Integer[].class, "1.2"));
  }

  @Test
  public void testAdaptingCommaSeparatedElementsShouldReturnArrayOfElements() {
    assertArrayEquals(new Integer[] {1, 2, 3}, Adapters.adapt(Integer[].class, "1,2,3"));
  }

  @Test
  public void testAdaptingCommaSeparatedElementsWithSpacesShouldReturnArrayOfElements() {
    assertArrayEquals(
        new Integer[] {1, 2, 3}, Adapters.adapt(Integer[].class, "  1  ,  2  ,  3  "));
  }

  @Test
  public void testAdaptingMissingFirstElementShouldReturnArrayWithNullFirstElement() {
    assertArrayEquals(new Integer[] {null, 2, 3}, Adapters.adapt(Integer[].class, ",2,3"));
  }
  ...
  public void testAdaptingMissingMiddleElementShouldReturnArrayWithNullMiddleElement() {
    assertArrayEquals(new Integer[] {1, null, 3}, Adapters.adapt(Integer[].class, "1,,3"));
  }
  ...
  public void testAdaptingMissingLastElementShouldReturnArrayWithNullLastElement() {
    assertArrayEquals(new Integer[] {1, 2, null}, Adapters.adapt(Integer[].class, "1,2,"));
  }
  ...
  public void testAdaptingCommaSeparatedWithSquareBracketsAndSpacesShouldReturnArrayOfElements() {
    assertArrayEquals(
        new Integer[] {1, 2, 3},
        Adapters.adapt(Integer[].class, "    [   1   ,   2   ,   3  ]    "));
  }
  ...
  public void testAdaptingCommaSeparatedElementsInvalidMiddleElementShouldThrowException() {
    assertArrayEquals(new Integer[] {1, null, 3}, Adapters.adapt(Integer[].class, "1,hello,3"));
  }

  @Test
  public void testAdaptingIllegalUseOfBracketsMiddleShouldThrowException() {
    assertArrayEquals(new Integer[] {1, null, null}, Adapters.adapt(Integer[].class, "1,[2,3]"));
  }

  @Test
  public void testAdaptingIllegalUseOfBracketsNonClosingShouldThrowException() {
    assertArrayEquals(new Integer[] {null, 2, 3}, Adapters.adapt(Integer[].class, "[1,2,3"));
  }
}
