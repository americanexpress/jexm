...
public class CharBoxedAdapterTest {

  @Test
  public void testAdaptingCharFromSingleCharacterStringA() {
    assertEquals('A', (char) Adapters.adapt(Character.class, "A"));
  }

  @Test
  public void testAdaptingCharFromSingleCharacterStringB() {
    assertEquals('B', (char) Adapters.adapt(Character.class, "B"));
  }
  ...
  public void testAdaptingCharFromSimpleString() {
    assertEquals('H', (char) Adapters.adapt(Character.class, "Hello World"));
  }
  ...
  public void testAdaptingCharFromAllSpacesString() {
    assertNull(Adapters.adapt(Character.class, "        "));
  }

  @Test
  public void testAdaptingCharNull() {
    assertNull(Adapters.adapt(Character.class, null));
  }
}
